...
public class BookValidationUnitTest {
    ...
    void whenAllFieldsAreCorrectValidationSucceeds() {
        final BookSaveRequest book = new BookSaveRequest("1234567891", "Sample Title", "Sample Author", new BigDecimal("19.9"));
    ...
    void whenIsbnDefinedButIncorrectThenValidationFails() {
        final BookSaveRequest book = new BookSaveRequest("123456789", "Sample Title", "Sample Author", new BigDecimal("19.9"));
        final Set<ConstraintViolation<BookSaveRequest>> validate = validator.validate(book);
